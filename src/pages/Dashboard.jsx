      ...
      <div className="px-6 mt-6">
        ...
        >
          <div>
            ...
            <p className="text-white/80 text-sm mt-1">PDF, image, text, DOCX</p>
          </div>
            ...
            {notes.map((note, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-card rounded-2xl p-4 flex items-center gap-4 card-shadow cursor-pointer active:scale-95 transition-transform"
                >
                  <div
