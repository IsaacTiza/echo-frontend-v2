      ...
      <PageTransition>
        <div className="min-h-dvh bg-background px-6 pt-14 pb-10">
          ...
          <p className="text-muted-foreground text-sm mb-8">
            Flashcards and quizzes are ready instantly after your note is
            processed.
          </p>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className="absolute inset-0 bg-card rounded-3xl p-8 flex flex-col items-center justify-center text-center card-shadow"
                >
